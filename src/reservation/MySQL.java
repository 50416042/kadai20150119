...
public class MySQL {
	...
	public MySQL() {
		...
		this.dbname  = "50416042";         // データベース名;
		this.url = "jdbc:mysql://" + server + "/" + dbname + "?useUnicode=true&characterEncoding=UTF-8";
		this.user = "50416042";         // データベース作成ユーザ名;
		this.password  = "50416042";     // データベース作成ユーザパスワード;
...
public int setReservation(String rdate, String st, String et, String reservation_userid, String facility){
 ...
 public int deleteReservation(String rdate,String reservation_userid,String facility_name){
     String sql = "DERETE FROM reservation WHERE date = '"+ rdate + "'AND user_id = '"+ reservation_userid 
